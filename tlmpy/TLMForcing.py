...
class WF(object):
    ...
    only for 2D grids
    '''
    def __init__(self,grid,xs,ys,diameters,Cts,zhs,Lfilter,wakemodel,coupling_location):
        '''
        ...
        coupling_location:
        - 'upstream_#': coupling based on velocity #D upstream of the first turbine
        ...
        '''
        if coupling_location.split('_')[0]=='upstream':
            self.__coupling = coupling_location.split('_')[0]
            self.__upstream_location = float(coupling_location.split('_')[1])
        else:
            self.__coupling = coupling_location
            self.__upstream_location = None
        self.__grid = grid
        self.__xs = xs
        self.__ys = ys
    ...
    def preprocess(self,abl,grid,WFfeedback):
        '''
        Standard function for preprocessing
    ...
    def u_upstream(self,abl,grid,u1r,v1r):
        ...
        xloc     = self.turbines[index].x-self.upstream_location*self.turbines[index].D*WDvector[0]
        yloc     = self.turbines[index].y-self.upstream_location*self.turbines[index].D*WDvector[1]
    ...
    @property
    def upstream_location(self):
        '''location upstream of the farm for WFfeedback'''
        return self.__upstream_location
    @property
    def Nturb(self):
        '''Number of turbines'''
        return self.__Nturb
