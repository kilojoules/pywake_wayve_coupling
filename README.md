# WAYVE
Python framework for the atmospheric perturbation model (APM).
...
The examples folder provides several basic workflow scripts that should demonstrate the code structure and post-processing tools.

### Authors
WAYVE has been developed by Dries Allaerts, Luca Lanzilao, Koen Devesse, Sebastiaan Jamaer, and Johan Meyers.

### Acknowledgements
The development of this code is supported by the European Research Council (FP7–Ideas, grant no. 306471), the Energy Transition Fund of the Belgian Federal Public Service for Economy, SMEs, and Energy (FOD Economie, K.M.O., Middenstand en Energie), and by the European Union Horizon Europe Framework programme (HORIZON-CL5-2021-D3-03-04) under grant agreement no. 101084205.

### How to cite
Devesse, Koen; Lanzilao, Luca; Allaerts, Dries; Jamaer, Sebastiaan; Meyers, Johan, 2023, "Wind-fArm gravitY-waVe and blockagE code", https://doi.org/10.48804/XMNVVY, KU Leuven RDR, V2

### License
WAYVE is distributed under the GNU AGPLv3 License.